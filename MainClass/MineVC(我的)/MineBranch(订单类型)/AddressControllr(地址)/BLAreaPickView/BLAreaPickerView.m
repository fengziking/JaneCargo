...
- (UIButton *)cancelButton{
    if (!_cancelButton) {
        ...
        [_cancelButton setTitleColor:kUIColorFromRGB(0x333333) forState:UIControlStateNormal];
...
- (NSInteger)pickerView:(UIPickerView *)pickerView numberOfRowsInComponent:(NSInteger)component{
    ...
    NSArray *cityArray = [[_areaArray objectAtIndex:_provinceSelectedRow] objectForKey:@"citylist" ];
    NSArray *areaArray = [[[[_areaArray objectAtIndex:_provinceSelectedRow] objectForKey:@"citylist" ] objectAtIndex:_citySelectedRow] objectForKey:@"arealist" ];
    switch (component) {
