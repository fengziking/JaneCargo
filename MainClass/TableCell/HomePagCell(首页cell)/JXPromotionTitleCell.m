...
@implementation JXPromotionTitleCell

// promotion
+ (instancetype)cellWithTable {
    
    return [[[NSBundle mainBundle] loadNibNamed:NSStringFromClass([JXPromotionTitleCell class]) owner:self options:nil] lastObject];
}
